...
output "vpc_details" {
  value = {
    ...
    "private-ap-southeast-1a" = {
      id                = aws_subnet.private_ap_southeast_1a.id
      cidr_block        = aws_subnet.private_ap_southeast_1a.cidr_block
      availability_zone = aws_subnet.private_ap_southeast_1a.availability_zone
    }
    "private-ap-southeast-1b" = {
      id                = aws_subnet.private_ap_southeast_1b.id
      cidr_block        = aws_subnet.private_ap_southeast_1b.cidr_block
      availability_zone = aws_subnet.private_ap_southeast_1b.availability_zone
    }
    "public-ap-southeast-1a" = {
      id                = aws_subnet.public_ap_southeast_1a.id
      cidr_block        = aws_subnet.public_ap_southeast_1a.cidr_block
      availability_zone = aws_subnet.public_ap_southeast_1a.availability_zone
    }
    "public-ap-southeast-1b" = {
      id                = aws_subnet.public_ap_southeast_1b.id
      cidr_block        = aws_subnet.public_ap_southeast_1b.cidr_block
      availability_zone = aws_subnet.public_ap_southeast_1b.availability_zone
    }
